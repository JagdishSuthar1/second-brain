...
export default function Hero() {
    return (
        <section className="py-9 w-full h-230 bg-[radial-gradient(ellipse_at_bottom_left,_#facc15,_#222222,_#000000)] text-white p-6">
            ...
            <div className="h-90 py-5 md:w-[60%] md:h-full md:flex md:flex-col md:justify-center lg:w-[60%] lg:px-15">
                ...
                <p className="text-[15px] text-white mt-5 lg:text-[21px] lg:mt-9 ">Capture ideas, organize knowledge, and think clearly—effortlessly. Our second brain app helps you turn scattered thoughts into structured insights, so you can focus on what matters most</p>
