...
return (
    ...
    <motion.div className="flex  min-w-max  h-30 py-9 [mask-image:linear-gradient(to_right,transparent,black,transparent)] text-5xl font-bold" animate ={{translateX : '-50%'}}  transition={{duration : 30 , repeat : Infinity , repeatType : 'loop', ease : "linear"}}>
