...
export default function DashboardPage() {
    ...
    return (
        <SidebarProvider className="w-screen h-screen border-box font-sans">
            ...
            <Toaster />
            <main
                className={`p-3 bg-[#191919] w-full h-screen flex flex-col gap-2 r-0`}
            >
                <div className={`flex flex-row w-full r-0 justify-between`}>
                    ...
                    <div className="flex flex-row gap-7 w-f">
                        ...
                        <Link to={"/chats"} className="mt-[5.3px]">
                            <span className="text-amber-50  text-[18px]  mt-2">
                                Super Brain
                            </span>
                        </Link>
                        ...
                        <Button
                            className="hover:cursor-pointer w-20 text-amber-50 hover:bg-amber-50 hover:text-black  text-[17px]"
                            ...
                            <CardContent className="w-full h-full flex flex-row flex-wrap gap-5  sm:flex-row sm:items-center sm:justify-center">
                                {[...dashboardData].length > 0 ? (
                                    [...dashboardData].map((item, index) => (
                                        ...
                                        <Card
                                            key={index}
                                            className="w-85 h-80 bg-[#222222] font-sans flex flex-col gap-3 p-2 "
                                        >
