...
// const ENDPOINT = import.meta.env.VITE_PUBLIC_URL
...
export default function ChatPage() {
    ...
    return (
        <div className="flex justify-center items-center w-screen h-screen text-2xl">SuperBrain is under working..</div>
    )
}